...
EXIT /b
	...
	::Punishment;
		:DIE
		CLS
		ECHO Hello, looks like you arent %name%.
		ECHO.
		ECHO.
		ECHO How about get your own Mega Menu?
                PING localhost -n 3 >NUL
		EXIT
	;
	...
	::Create user account code;
		...
		::Create password;
			...
			ECHO #  # #     #  # #
                        ...
                        ECHO #    #  #      # #
                        ECHO #     ##        # #ENU
			ECHO Your password has not been set yet.
		...
		::Create username;
			...
			ECHO #  # #     #  # #
                        ...
                        ECHO #    #  #      # #
                        ECHO #     ##        # #ENU
			ECHO Looks like you don't have a name.
			ECHO.
			ECHO Type your preferred name
			ECHO.
			SET /p newname=
			CLS
			ECHO Hi There, %newname%!
			ECHO.
			PAUSE
		...
		::Un-matching variables;
			...
			ECHO #  # #     #  # #
                        ...
                        ECHO #    #  #      # #
                        ECHO #     ##        # #ENU
			ECHO Sorry, your passwords don't match. Maybe try to do it again?
			ECHO.
			PAUSE
	...
	::Create maintenance files;
		...
		ECHO ai.speak "Welcome to the modified Mega Menu" >> "greetings1.vbs"
		ECHO ' > "greetings2.vbs"
		...
		ECHO ai.speak "And Welcome back to The Modified Mega Menu" >> "greetings2.vbs"
		ECHO :: > "pass.bat"
		ECHO SET name=%newname% >> "pass.bat"
		ECHO SET pass=%newpass1%>> "pass.bat"
		...
		ECHO Please note: Your hint can't contain spaces :( , use _ (underscore) instead :)!
		SET /p hintm=
